...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=2615863949ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=gestion_asistencias&table=asistencias">`gestion_asistencias`.`asistencias`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=gestion_asistencias&table=trabajadores">`gestion_asistencias`.`trabajadores`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=gestion_asistencias&table=usuarios">`gestion_asistencias`.`usuarios`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=gestion_asistencias&table=consultas_asistencias">`gestion_asistencias`.`consultas_asistencias`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=floreser&table=users">`floreser`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=floreser&table=direccion">`floreser`.`direccion`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=floreser&table=products">`floreser`.`products`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=floreser&table=purchases">`floreser`.`purchases`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=floreser&table=ventas">`floreser`.`ventas`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=floreser&table=compras">`floreser`.`compras`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="25436b7025653c384c796e435d2c4c42">
